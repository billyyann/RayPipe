...
if __name__ == "__main__":
    # runtime_env = {"container":{"image": "docker.4pd.io/ray_tensorflow2:pipe-105-commit-aa96d082"}}
    # runtime_env = {"pip": [ "tensorflow-cpu==2.3.0"]}
    ray.init(address="ray://172.27.69.28:32071",
